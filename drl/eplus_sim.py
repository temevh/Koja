...
def get_reward(step_data: Dict[str, Any]) -> float:
    ...
    The dict *step_data* contains every sensor / meter alias defined in
    variable_config.py plus time fields (hour, day_of_week, …).

    A good starting point is a weighted negative sum of:
        - energy consumption  (electricity_hvac, gas_total)
        - thermal comfort deviation from setpoint bands
