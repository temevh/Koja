...
ZONE_HTG_SETPOINT_LOW  = 21.5   # heating setpoint at outdoor <= 0 °C
...
ZONE_CLG_SETPOINT_LOW  = 21.5   # cooling setpoint at outdoor <= 0 °C
...
SUP_TEMP_AT_HIGH = 19.0         # supply air temp when return air is warm
